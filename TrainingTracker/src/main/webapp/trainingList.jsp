...
<a href="<%=request.getContextPath()%>/TrainingServlet">Trainings</a>
</header>			
...
<div align = "center"></div>
			<table border ="1">
				...
				<tbody>
					...
					<c:forEach var="train" items="${training}">

						<tr>
							<td><c:out value="${train.courseId}" /></td>
							<td><c:out value="${train.courseName}" /></td>						
							<td><c:out value="${train.start}" /></td>
							<td><c:out value="${train.end}" /></td>						
							
							<td><a href="Details?courseID=<c:out value='${train.courseId}'/>">Details</a></td>
